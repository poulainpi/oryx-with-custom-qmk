...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    TD(DANCE_0),    KC_Q,           TD(DANCE_1),    TD(DANCE_2),    TD(DANCE_3),    TD(DANCE_4),                                    KC_Y,           KC_U,           KC_I,           KC_O,           KC_P,           KC_EQUAL,       
    TT(5),          MT(MOD_LCTL, KC_A),MT(MOD_LALT, KC_S),MT(MOD_LSFT, KC_D),LT(2,KC_F),     TD(DANCE_5),                                    KC_H,           LT(3,KC_J),     MT(MOD_LSFT, KC_K),MT(MOD_LALT, KC_L),MT(MOD_LCTL, KC_SCLN),KC_QUOTE,       
    TT(1),          TD(DANCE_6),    TD(DANCE_7),    TD(DANCE_8),    TD(DANCE_9),    TD(DANCE_10),                                   KC_N,           TD(DANCE_12),   KC_COMMA,       KC_DOT,         KC_SLASH,       KC_MINUS,       
    KC_HYPR,        KC_MEH,         CW_TOGG,        KC_TAB,         TD(DANCE_11),   KC_SPACE,                                       TD(DANCE_13),   TD(DANCE_14),   RCTL(RSFT(KC_TAB)),TD(DANCE_15),   KC_BSLS,        KC_RIGHT_GUI,   
                                                    TT(4),          KC_MS_BTN1,                                     KC_MS_BTN2,     TT(4)
  ),
  [1] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_F,           TD(DANCE_16),   KC_B,                                           KC_J,           KC_L,           KC_U,           KC_Y,           KC_SCLN,        KC_TRANSPARENT, 
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, TD(DANCE_17),   TD(DANCE_18),                                   KC_K,           TD(DANCE_19),   KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
