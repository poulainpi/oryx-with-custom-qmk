...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    ...
    MT(MOD_LSFT, KC_SPACE),LT(2,KC_DELETE),MO(3),                          MO(3),          TD(DANCE_2),    MT(MOD_RSFT, KC_ENTER)
  ),
  [1] = LAYOUT_moonlander(
    KC_TRANSPARENT, TD(DANCE_3),    TD(DANCE_4),    TD(DANCE_5),    TD(DANCE_6),    TD(DANCE_7),    DM_RSTP,                                        KC_TRANSPARENT, TD(DANCE_8),    TD(DANCE_9),    TD(DANCE_10),   TD(DANCE_11),   TD(DANCE_12),   KC_F11,         
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                 KC_TRANSPARENT, TD(DANCE_13),   KC_TRANSPARENT
  ),
  [2] = LAYOUT_moonlander(
...
const uint16_t PROGMEM combo0[] = { KC_G, KC_RIGHT, COMBO_END};
const uint16_t PROGMEM combo1[] = { KC_LEFT, KC_H, COMBO_END};
const uint16_t PROGMEM combo2[] = { KC_T, KC_UP, COMBO_END};
const uint16_t PROGMEM combo3[] = { KC_DOWN, DE_Z, COMBO_END};

combo_t key_combos[COMBO_COUNT] = {
    COMBO(combo0, LGUI(LCTL(KC_RIGHT))),
    COMBO(combo1, LGUI(LCTL(KC_LEFT))),
    COMBO(combo2, LGUI(LCTL(KC_UP))),
    COMBO(combo3, LGUI(LCTL(KC_DOWN))),
};
...
const uint8_t PROGMEM ledmap[][RGB_MATRIX_LED_COUNT][3] = {
    [0] = { {29,255,255}, {0,245,245}, {139,220,199}, {0,245,245}, {139,220,199}, {139,220,199}, {29,255,255}, {139,220,199}, {29,255,255}, {128,245,246}, {139,220,199}, {29,255,255}, {139,220,199}, {29,255,255}, {128,245,246}, {139,220,199}, {29,255,255}, {139,220,199}, {29,255,255}, {195,175,245}, {139,220,199}, {29,255,255}, {139,220,199}, {29,255,255}, {128,245,246}, {139,220,199}, {29,255,255}, {29,255,255}, {29,255,255}, {29,255,255}, {5,255,255}, {0,245,245}, {0,245,245}, {29,255,255}, {0,245,245}, {195,175,245}, {29,255,255}, {29,255,255}, {139,220,199}, {0,245,245}, {128,245,246}, {139,220,199}, {29,255,255}, {139,220,199}, {29,255,255}, {128,245,246}, {139,220,199}, {29,255,255}, {139,220,199}, {29,255,255}, {128,245,246}, {139,220,199}, {29,255,255}, {139,220,199}, {29,255,255}, {195,175,245}, {139,220,199}, {29,255,255}, {139,220,199}, {29,255,255}, {128,245,246}, {139,220,199}, {29,255,255}, {29,255,255}, {29,255,255}, {29,255,255}, {5,255,255}, {0,245,245}, {0,245,245}, {29,255,255}, {0,245,245}, {195,175,245} },
