const uint16_t PROGMEM combo0_eng[] = { KC_Y, LT(7, KC_U), KC_I, COMBO_END};
const uint16_t PROGMEM combo0_rus[] = { RU_EN, RU_GHE, RU_SHA, COMBO_END};
const uint16_t PROGMEM combo1[]     = { KC_I, KC_O, KC_P, COMBO_END};
const uint16_t PROGMEM combo2_eng[] = { LT(7, KC_U), KC_I, KC_O, COMBO_END};
...
const uint16_t PROGMEM combo6_eng[] = { LT(10, KC_W), KC_E, LT(7, KC_R), COMBO_END};
