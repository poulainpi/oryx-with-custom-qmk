...
const uint16_t PROGMEM combo4[] = { MT(MOD_LGUI, KC_A), MT(MOD_LALT, KC_S), MT(MOD_LSFT, KC_D), COMBO_END};
const uint16_t PROGMEM combo5_eng[] = { MT(MOD_LSFT, KC_D), MT(MOD_LCTL, KC_F), LT(7, KC_G), COMBO_END};
const uint16_t PROGMEM combo5_rus[] = { MT(MOD_LSFT, RU_VE), MT(MOD_LCTL, RU_A), LT(8, RU_PE), COMBO_END};
...
combo_t key_combos[] = {
    ...
    COMBO(combo5_eng, CW_TOGG),
    COMBO(combo5_rus, CW_TOGG),
