...
const uint16_t PROGMEM c_lngsw_grp[] = { KC_F, KC_O, KC_U, COMBO_END};
const uint16_t PROGMEM c_lngsw_rus[] = { RU_GHE, RU_SHA, RU_SHCH, COMBO_END};
...
combo_t key_combos[] = {
    ...
    COMBO(c_lngsw_grp, LANG_SWITCH_COMBO_ACTION),
    COMBO(c_lngsw_rus, LANG_SWITCH_COMBO_ACTION),
